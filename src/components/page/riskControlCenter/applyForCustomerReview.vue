      ...
      <el-row>
        <el-col :span="12">
          <el-button-group>
            ...
            <el-button>待通过</el-button>
            <el-button>待驳回</el-button>
            <el-button>已通过</el-button>
            <el-button>高风险</el-button>
    ...
    <template>
      <el-table class="m20" :data="tableData" border height="600">
        ...
        <el-table-column label="业务员" align="center">
          <template slot-scope="scope">
            <el-button type="warning" size="mini" plain @click="handleSalesman(scope.row)">{{scope.row.salesman}}
            </el-button>
          </template>
        </el-table-column>
        <el-table-column prop="source" label="来源" align="center"></el-table-column>
        <el-table-column prop="gender" label="性别" align="center"></el-table-column>
        <el-table-column prop="IDNumber" label="身份证号" align="center" width="150"></el-table-column>
        <el-table-column prop="telephone" label="电话" align="center"></el-table-column>
        <el-table-column prop="organization" label="工作单位" align="center" width="200"></el-table-column>
        <el-table-column label="状态" align="center">
          <template slot-scope="scope">
            <el-tag
              :type="scope.row.state===1?'warning':'success'">
              {{scope.row.state ===1?'审核中':'待通过'}}
            </el-tag>
          </template>
        </el-table-column>
        <el-table-column label="认证" align="center">
          <template slot-scope="scope">
            <el-tag
              :type="scope.row.approve===1?'warning':'success'">
              {{scope.row.approve ===1?'已认证':'未认证'}}
            </el-tag>
          </template>
        </el-table-column>
        <el-table-column prop="ApplicationDate" label="申请时间" align="center"></el-table-column>
        ...
        <template>
          <div id="clientDetails">
            ...
            <el-row>
              ...
              <el-col :span="22">
                <template>
                  <el-table :data="pneumaticTable" style="width: 100%;border: 1px solid #ccc">
